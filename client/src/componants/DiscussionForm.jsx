...
const Discussionform = () => {
  ...
  useEffect(() => {
      ...
      .then((res) => {
        setSelectedLanguage(res.data[0]?.label); 
      })
      .catch((err) => {
        console.log(err);
      });
      ...
      .then((res) => {
        ...
        setSelectedLevel(res.data[0]?.label); 
      })
      .catch((err) => {
        console.log(err);
      });
...
<br/>
            <form className='form-group' onSubmit={handleSubmit}>
              ...
              {selectedLanguage? <option >{selectedLanguage}</option> : <option value="">Select Language</option>}
              ...
              <select required onChange={(e) => {
                ...
                {selectedLevel? <option >{selectedLevel}</option> : <option value="">Select Level</option>}
