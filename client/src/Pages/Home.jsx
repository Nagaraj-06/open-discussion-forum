...
const Home = () => {
  ...
  return (
    <div className='bodyy'>
    <FirstHeader searchh= {(data)=> setSearch(data)} content={`Welcome to the PS Discussion Forum`} Languages={languagesCount} Level={levelCount} Posts= {postsCount} />
            ...
            return(
                <tr>
                  <td className='imagetd'>
                      <NavLink to={`/profile?userId=${userId}`} style={{ textDecoration: 'none',  color: "#11297f" }} > <img src={Img1}></img> </NavLink>
                  </td>

                  <td className='columntwo'> <NavLink to={`/profile?userId=${userId}`} style={{ textDecoration: 'none',  color: "#11297f" }}><b>{username}</b> </NavLink> on<br/>
