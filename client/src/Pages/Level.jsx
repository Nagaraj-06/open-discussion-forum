...
let level_count=0;
let level_username,level_lastpostDate,level_lastpostTime,level_Lastpost=[];
...
levels.map((level,index)=>{
  ...
  return (
    <div className='bodyy'>
       ...
       <FirstHeader searchh= {(data)=> setSearch(data)} content={`${language} `} Languages={language_name} Level={levels.length} Posts= {PostsCount} />
