...
// Add a new Reply
router.post('/mainrEditSubReplyeplies',upload?.single('image'),ReplyController.addReply);

// Edit a Reply 
router.post('/EditMainReply',upload?.single('image'),ReplyController.EditMainReply)

// Add Sub Reply
router.post('/subreplies',upload?.single('image'),ReplyController.addSubreply)

router.post('/Editsubreplies',upload?.single('image'),ReplyController.Editsubreplies)
