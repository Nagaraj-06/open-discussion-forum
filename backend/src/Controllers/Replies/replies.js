...
const ReplyController={
    ...
    try{
        ...
        if(image) {
            sqlquery ='INSERT INTO reply_details (from_email,to_email,language_id,level_id,post_id,body,image,date,time) VALUES (?, ?,?, ?, ?, ?, ? ,? ,?)';
            queryParams=  [ from_email,to_email,language_id,level_id,post_id,body,image,date,time  ];
        }
        else{
            sqlquery ='INSERT INTO reply_details (from_email,to_email,language_id,level_id,post_id,body,date,time ) VALUES (? ,?,? ,?,? , ? ,?, ?)';
            queryParams=   [ from_email,to_email,language_id,level_id,post_id,body,date,time  ];
        }
    ...
    addSubreply: async (req,res)=>{
        ...
        if(to_sub_replyid==null) {
                ...
                if(image) {
                    sqlquery ='INSERT INTO sub_replies (from_email,to_main_replyid,body,image,date,time ) VALUES (? , ?,?, ?, ?, ?)';
                    queryParams=  [ from_email,to_main_replyid,body,image,date,time  ];
                }
                else{
                    sqlquery ='INSERT INTO sub_replies ( from_email, to_main_replyid, body, date,time ) VALUES (? ,?, ?, ?, ? )';
            ...
            if(image) {
                sqlquery ='INSERT INTO sub_replies (from_email,to_sub_replyid,body,image,date,time ) VALUES (? , ?, ?, ?, ?, ? )';
                queryParams=  [ from_email,to_sub_replyid,body,image,date,time  ];
            }
            else{
                sqlquery ='INSERT INTO sub_replies ( from_email, to_sub_replyid , body, date,time ) VALUES (? ,? ,? , ?, ?)';
    ...
    saveReply: async (req,res)=>{
        ...
        try{
            ...
            if(SubReplyId==null) {
                sqlquery="select status from reply_saved where email=? and post_id=? and MainReplyId=?";
                queryParams=[email,id,MainReplyId]
            }else if(MainReplyId==null) {
                sqlquery="select status from reply_saved where email=? and post_id=? and SubReplyId=?";
                queryParams=[email,id,SubReplyId]
            }
            ...
            db.query(sqlquery,queryParams,
                (err,result)=>{
                    if(err) {
                        ...
                        if(result.length==0) {
                            if(SubReplyId==null) {
                                sqlquery="insert into reply_saved(email,post_id,MainReplyId,status) values (?,?,?,?)";
                                queryParams=[email,id,MainReplyId,status]
                            }else if(MainReplyId==null) {
                                sqlquery="insert into reply_saved(email,post_id,SubReplyId,status) values (?,?,?,?)";
                            ...
                            db.query(sqlquery,
                                ...
                                if(SubReplyId==null) {
                                    sqlquery="update reply_saved set status=? where email=? and post_id=? and MainReplyId=?";
                                    queryParams=[status,email,id,MainReplyId]
                                }else if(MainReplyId==null) {
                                    sqlquery="update reply_saved set status=? where email=? and post_id=? and SubReplyId=?";
    ...
    GetReplyLang_Level: async (req,res)=>{
        ...
        try{   
            ...
            db.query("select * from reply_details where level_id=? and language_id=?",
    ...
    getlang_reply: async (req,res)=>{
        ...
        try{
            ...
            db.query("select * from reply_details where language_id=?",
                [language_id],
                (err,result)=>{
                        if(err) {
                            console.log(err)
